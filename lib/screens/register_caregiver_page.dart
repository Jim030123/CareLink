...
class _RegisterCaregiverPageState extends State<RegisterCaregiverPage> {
  ...
  void _handleNext() {
    ...
    if (widget.onNext != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Form valid — implement onNext to proceed')));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create Primary Caregiver Account', style: TextStyle(fontSize: 18.sp, color: Colors.black)),
        centerTitle: true,
      ),
      body: SafeArea(
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Create Primary Caregiver Account', style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w600)),
                    SizedBox(height: 8.h),
                    Text(
